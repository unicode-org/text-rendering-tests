/* mirroring.tab.i
 * generated by gen-mirroring-tab (fribidi 1.0.1)
...
/*
  ...
  required memory: 1720
  lookups: 3
  partition shape: Mir[256][64][4]
  different table entries: 1 14 39
*/

/* *INDENT-OFF* */

static const int16_t MirLev2[4*39] = {
...
#define MirLev2_22FC 0x64
  -8,-7,-7,0,
#define MirLev2_27C8 0x68
  1,-1,0,2,
#define MirLev2_2984 0x6C
  -1,1,-1,1,
#define MirLev2_298C 0x70
  -1,3,1,-1,
#define MirLev2_2990 0x74
  -3,1,-1,1,
#define MirLev2_29B8 0x78
  -1824,0,0,0,
#define MirLev2_29F4 0x7C
  0,-2016,0,0,
#define MirLev2_2AAC 0x80
  1,-1,0,1,
#define MirLev2_2AB0 0x84
  -1,0,0,1,
#define MirLev2_2ADC 0x88
  0,0,-2104,0,
#define MirLev2_2AE0 0x8C
  0,0,0,-2106,
#define MirLev2_2AE4 0x90
  -2108,-2106,0,0,
#define MirLev2_FF5C 0x94
  0,-2,0,1,
#define MirLev2_FF60 0x98
  -1,0,1,-1,
};
...
#define MirLev1_2700 0x1C0
  ...
  MirLev2_27C8,  /* 27C8..27CB */
  MirLev2_005C,  /* 27CC..27CF */
...
#define MirLev1_2E00 0x280
  ...
  MirLev2_2264,  /* 2E20..2E23 */
  MirLev2_2264,  /* 2E24..2E27 */
  MirLev2_0028,  /* 2E28..2E2B */
